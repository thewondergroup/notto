...
const MENU = {
  pasta:[
    {id:'pappardelle', name:'Pappardelle', price:'', asset:'pappardelle',
      ...
      blurb:'Slow-cooked beef, field mushrooms and red wine folded through fresh pappardelle.',
    ...
    {id:'rigatoni', name:'Rigatoni', price:'', asset:'rigatoni',
      ...
      blurb:'Sun-ripened tomato, sweet onion, mozzarella and basil. Simple ingredients doing exactly what they should.',
    ...
    {id:'gnocchetti', name:'Gnocchetti', price:'', asset:'gnocchetti',
      ...
      blurb:'Smashed sausage with fennel, chilli, white wine and garlic. Rich, rustic and generous.',
    ...
    {id:'tagliolini', name:'Tagliolini nero', price:'', asset:'tagliolini-nero',
      ...
      blurb:'Squid-ink tagliolini with a bolognese of prawns, sweet peppers, tomato and chilli.',
    ...
    {id:'bucatini', name:'Bucatini', price:'', asset:'bucatini',
      ...
      blurb:'Chilli, garlic, extra-virgin olive oil and toasted crumbs. Proof that simple food can be seriously good.',
    ...
    {id:'spaghetti', name:'Spaghetti', price:'', asset:'spaghetti',
      ...
      blurb:'Chilli, garlic, extra-virgin olive oil and toasted crumbs. A classic for good reason.',
  ...
  salads:[
    ...
    {id:'tuscan', name:'The Tuscan', price:'', asset:'salad-tuscan',
      ...
      blurb:'Sweet peppers, artichoke hearts, red onions, cannellini beans and balsamic.',
    ...
    {id:'lunchbox', name:'NOTTO Mediterranean lunchbox', price:'', asset:'lunchbox',
      ...
      blurb:'Roasted peppers and red onions, dressed cannellini beans with tomato and pesto, bocconcini mozzarella, marinated courgettes with lemon and marjoram, finished with olives. Add chicken, tuna or egg if you like.',
